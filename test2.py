...
"""Print the elements of a list in descending order"""
def print_descending(myList):
    descended_list = sorted(myList, key = int, reverse = True)
    print("The descended list is " + repr(descended_list))
    return 0
